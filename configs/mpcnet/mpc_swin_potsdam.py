...
model = dict(
    ...
    train_cfg=dict(),
    test_cfg=dict(mode='slide', crop_size=(512, 512), stride=(280, 280)))
dataset_type = 'ISPRSDataset'
data_root = 'data/vaihingen/converted'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type='PotsdamDataset',
        data_root='data/potsdam/converted',
...
gpu_ids = range(0, 4)
auto_resume = False
work_dir = 'work_dirs/potsdam/fpn_swin_potsdam_baseline/'
